...
if __name__ == '__main__':
    ...
    os.makedirs(dataset_dir + '/SegmentationClassAugVal', exist_ok=True)
    files_list = os.listdir(os.path.join(dataset_dir, 'SegmentationClassAug'))
    file_available_list = []
    ...
    for file_name in files_val_list:
        file_name_seg_src = os.path.join(dataset_dir, 'SegmentationClassAug', file_name)
        file_name_seg_tar = os.path.join(dataset_dir, 'SegmentationClassAugVal', file_name)
